 ...
 * @license  URI: http://www.gnu.org/licenses/gpl-2.0.html
 * @link     https://sms.softeriatech.com/
 * SOFTSMAL_NinjaForm class.
 */
class SOFTSMAL_NinjaForm extends FormInterface
{
     ...
     * @var stirng
     */
    private $form_session_var = SOFTSMAL_FormSessionVars::NF_FORMS;
     ...
     * @var stirng
     */
    private $form_phone_ver = SOFTSMAL_FormSessionVars::NF_PHONE_VER;
    ...
    public function handleForm()
    {
        ...
        add_action('ninja_forms_after_submission', __CLASS__ . '::smsproSendSmsFormSubmit', 10, 1);
    }
     ...
     * @return void
     */
    public static function smsproSendSmsFormSubmit( $form_data )
    {
        $datas = array();
        if (! empty($form_data) ) {
            $billing_phone = '';
