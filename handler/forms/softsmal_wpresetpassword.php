...
class WPResetPassword extends FormInterface
{
     ...
     * @var stirng
     */
    private $form_session_var = SOFTSMAL_FormSessionVars::WP_DEFAULT_LOST_PWD;
    ...
    public function handleForm()
    {
        ...
        wp_enqueue_style('wpv_sa_common_style', SA_MOV_CSS_URL, array(), SOFTSMAL_Constants::SA_VERSION, false);
        $this->routeData();
    }
    ...
    public function handleSmsalertChangedPwd( $post_data )
    {
        ...
        if (empty($new_password) ) {
            $error = SOFTSMAL_Messages::showMessage('ENTER_PWD');
        }
        if ($new_password !== $confirm_password ) {
            $error = SOFTSMAL_Messages::showMessage('PWD_MISMATCH');
        }
        if (! empty($error) ) {
            smsproAskForResetPassword(
    ...
    public function fetchPhoneAndStartVerification( $user, $key, $username, $password, $phone_number )
    {
        ...
        softeria_alerts_site_challenge_otp($user, $username, null, $phone_number, 'phone', $password, SOFTSMAL_Utility::currentPageUrl(), false);
    }
    ...
    public function handle_post_verification( $redirect_to, $user_login, $user_email, $password, $phone_number, $extra_data )
    {
        ...
        smsproAskForResetPassword(
            sanitize_text_field($_SESSION['user_login']),
            sanitize_text_field($_SESSION['phone_number_mo']),
            SOFTSMAL_Messages::showMessage('CHANGE_PWD'),
            'phone',
            false
        );
    }
