...
class SimplyAppoinments extends FormInterface
{
    ...
    public static function setBookingReminder($appointment_id,$form_data,$appoinmentStatus)
    {
		...
		$customer_timezone = new DateTimeZone( $form_data['customer_timezone'] );
		$format = SSA_Utils::localize_default_date_strings( 'y-m-d H:i:s' );			
		$form_data['customer_start_date'] = ssa_datetime( $form_data['start_date'] )->setTimezone( $customer_timezone )->format( $format );		
    ...
    public static function addTabs($tabs=[])
    {
        ...
        'kb_link'      => array(
        'href'   => 'https://sms.softeriatech.com/knowledgebase/simply-appointments-sms-integration/',
        'target' => '_blank',
    ...
    public static function getBookingvariables()
    {
        ...
        $variable['[customer_start_date]']  = 'Start Date';
