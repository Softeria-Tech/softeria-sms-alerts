 ...
 * @license  URI: http://www.gnu.org/licenses/gpl-2.0.html
 * @link     https://sms.softeriatech.com/
 * SOFTSMAL_VendorRegistrationForm class.
 */
class SOFTSMAL_VendorRegistrationForm extends FormInterface
{
     ...
     * @return stirng
     */
    private $form_session_var = SOFTSMAL_FormSessionVars::PV_DEFAULT_REG;
    ...
    public static function vendorsRegCustomFields()
    {
        ...
        echo '<script>document.addEventListener("DOMContentLoaded", function() {			jQuery(".wcpv-shortcode-registration-form").addClass("sa-wcpv-form");
		});
		</script>';  
...
new SOFTSMAL_VendorRegistrationForm();
