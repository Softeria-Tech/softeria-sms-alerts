...
class ContactForm7 extends FormInterface
{
    ...
    public function handleForm()
    {
        ...
        add_action('wpcf7_init', array( $this, 'smsproWpcf7AddShortcodePhonefieldFrontend' ));
        add_filter('wpcf7_messages', array( $this, 'wpcf7BillingPhoneMessages' ), 10, 1);
        add_action('wpcf7_admin_notices', array( $this,'smsproWpcf7ShowWarnings'), 10, 3);
        add_filter('wpcf7_validate', array( $this,'smsproValidation'), 10, 2);
    }
     ...
     * @return void.
     */
    public function smsproValidation($result, $tags)
    { 
     ...
     * @return void
     */
    function smsproWpcf7ShowWarnings($page,$action,$object)
    {
     ...
     * @return string
     */
    public function smsproWpcf7ShortcodeHandler( $tag )
    {
    ...
    public function addSmsalertPhoneTagV2()
    {
        if (class_exists('WPCF7_TagGenerator') ) {
            ...
            $tag_generator->add('billing_phone', __('SMSALERT PHONE', 'contact-form-7'), array( $this, 'smsproWpcf7TagGeneratorTextV2' ),array('version'=>2));
        }
    }
    ...
    public function addSmsalertPhoneTag()
    {
        if (class_exists('WPCF7_TagGenerator') ) {
            $tag_generator = WPCF7_TagGenerator::get_instance();
            $tag_generator->add('billing_phone', __('SMSALERT PHONE', 'contact-form-7'), array( $this, 'smsproWpcf7TagGeneratorText' ));
        }
    }
     ...
     * @return void
     */
    public function smsproWpcf7TagGeneratorText( $contact_form, $args = '' )
    {
     ...
     * @return void
     */
    public function smsproWpcf7TagGeneratorTextV2( $contact_form, $options = '' )
    {
