...
<p>Contributors: Softeria Tech Ltd</p>
<p>Tags: order notification, order SMS, woocommerce sms integration, sms plugin, mobile verification, bulk sms</p>
<p>Requires at least: 4.6</p>
<p>Tested up to: 6.8</p>
<p>Stable tag: 1.0.0</p>
<p>Requires PHP: 5.6</p>
<p>License: GPLv2</p>
<p>License URI: http://www.gnu.org/licenses/gpl-2.0.html</p>

<p>A plugin for sending SMS notification after placing orders using WooCommerce</p>

## Description

<p>This is a WooCommerce add-on. By Using this plugin admin and buyer can get notification about their order via sms using SMS Alert./p>
...
<p>PS: This plugin requires an account(paid/demo) with [sms.softeriatech.com](https://sms.softeriatech.com) service to send SMS. Demo account comes with some free credits to let you test it out./p>
...
* Sync Customers to Group on [sms.softeriatech.com](https://sms.softeriatech.com)
* Auto Shorten URL
...
* 👉 [MultiVendorX Marketplace](https://wordpress.org/plugins/dc-woocommerce-multi-vendor/)
...
There is no provision to integrate any other SMS Gateway, we only support [SMS Alert](http://sms.softeriatech.com/) SMS Gateway.

### How do i change Sender id?

You can request the sender id after login to your [SMS Alert](http://sms.softeriatech.com/) account, from manage sender id.
...
If still you face any issues, please [contact](https://wordpress.org/support/plugin/sms-pro) our support team.
...
Please check complete list of supported countries on our [website](https://sms.softeriatech.com)
...
Please use wordpress [support forum](https://wordpress.org/support/plugin/sms-pro) for new feature request, our development team may consider it in future updates. Please note we do not have any plans to develop any integrations for any paid plugins, if still you need it someone like you must sponser the update
