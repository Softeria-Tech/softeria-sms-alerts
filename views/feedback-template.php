...
if (empty($pagenow) || 'plugins.php' != $pagenow ) {
    ...
    $form_fields = apply_filters('smspro_deactivation_form_fields', array());
?>
<?php if (! empty($form_fields) ) : ?>
    <div class="smsf-onboarding-section">
        ...
        <div class="smsf-on-boarding-wrapper">
            ...
            <p class="smsf-on-boarding-desc"><?php esc_html_e('May we have a little info about why you are deactivating?', 'sms-pro'); ?></p>
            <form action="#" method="post" class="smsf-on-boarding-form">
                ...
                <div class="smsf-on-boarding-form-no_thanks">
                    <a href="#" onclick="return false;" class="smsf-deactivation-no_thanks"><?php esc_html_e('Skip and Deactivate Now', 'sms-pro'); ?></a>
                </div>
                </div>
            </form>
        </div>
