...
<div class="cvt-accordion <?php echo $disablePlayground; ?>">
    ...
    <?php foreach ( $forminator_forms as $ks => $vs ) { ?>
        <div class="cvt-accordion-body-title" data-href="#accordion_<?php echo esc_attr($ks); ?>">
            <input type="checkbox" name="smspro_forminator_general[forminator_admin_notification_<?php echo esc_attr($ks); ?>]" id="smspro_forminator_general[forminator_admin_notification_<?php echo esc_attr($ks); ?>]" class="notify_box" <?php echo ( ( smspro_get_option('forminator_admin_notification_' . $ks, 'smspro_forminator_general', 'on') === 'on' ) ? "checked='checked'" : '' ); ?>/><label><?php echo esc_html(ucwords(str_replace('-', ' ', $vs))); ?></label>
        ...
        ?>
                ...
                <textarea data-parent_id="smspro_forminator_general[forminator_admin_notification_<?php echo esc_attr($ks); ?>]" name="smspro_forminator_message[forminator_admin_sms_body_<?php echo esc_attr($ks); ?>]" id="smspro_forminator_message[forminator_admin_sms_body_<?php echo esc_attr($ks); ?>]" <?php echo( ( smspro_get_option('forminator_admin_notification_' . esc_attr($ks), 'smspro_forminator_general', 'on') === 'on' ) ? '' : "readonly='readonly'" ); ?> class="token-area"><?php echo esc_textarea(smspro_get_option('forminator_admin_sms_body_' . $ks, 'smspro_forminator_message', SmsAlertMessages::showMessage('DEFAULT_CONTACT_FORM_ADMIN_MESSAGE'))); ?></textarea>
