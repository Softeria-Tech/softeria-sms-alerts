                                                                ...
                                                                <td align="center" style="padding-top:10px;padding-bottom:17px">
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="center">
                                                                                    <center><a href="https://sms.softeriatech.com/#pricebox" style="background:#03a9f4;border-radius:3px;color:#ffffff;display:block;font-family:Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;font-weight:normal;letter-spacing:1px;padding:14px 8px;text-decoration:none" target="_blank">BUY CREDIT </a></center>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
