 ...
 * @license  URI: http://www.gnu.org/licenses/gpl-2.0.html
 * @link     https://sms.softeriatech.com/
 * SOFTSMAL_Share_Cart class
 */
class SOFTSMAL_Share_Cart
{
    ...
    {
        wp_enqueue_script('share_cart_admin_script', SA_MOV_URL . 'js/share_cart_front_script.js', false, SOFTSMAL_Constants::SA_VERSION);
        wp_localize_script(
    ...
    {
        $cart = SOFTSMAL_Cart_Admin::restoreCart();
    }
    ...
    public function getSmsAlertShareCartTemplates()
    {
        ...
        $text_body        = softeria_alerts_get_option(
            ...
            SOFTSMAL_Messages::showMessage('DEFAULT_SHARE_CART_MSG')
        );
    ...
    function shareCartPopupDiv()
    {
        ...
        if (is_plugin_active('elementor/elementor.php') && !empty($post)) {  
            ...
            $content = SOFTSMAL_Popup::getShareCartStyle();
    ...
    function saveShareCartData()
    {
        ...
        if (isset($_REQUEST['sc_umobile']) ) {
            ...
            $sc_fmobile = SOFTSMAL_cURLOTP::checkPhoneNos($sc_fmobile);
            
            $sc_umobile = SOFTSMAL_cURLOTP::checkPhoneNos($sc_umobile);
            ...
            if (empty($product_array) ) {
                SOFTSMAL_Cart_Admin::clearCartData();
                return;
            }
