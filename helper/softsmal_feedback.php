 ...
 * @license  URI: http://www.gnu.org/licenses/gpl-2.0.html
 * @link     https://sms.softeriatech.com/
 * SOFTSMAL_Feedback class
 */
class SOFTSMAL_Feedback
{
    ...
    public function enqueueStyles()
    {
        if ($this->isValidPageScreen() ) {
            ...
            wp_enqueue_style('admin-feedback-style', plugins_url('../css/feedback-admin.css', __FILE__), array(), SOFTSMAL_Constants::SA_VERSION);
        }
    }
    ...
    public function enqueueScripts()
    {
        ...
        if ($this->isValidPageScreen() ) {
            ...
            wp_enqueue_script('admin-feedback-scripts', plugins_url('../js/feedback-admin.js', __FILE__), array( 'jquery' ), SOFTSMAL_Constants::SA_VERSION, true);
    ...
    public function sendOnboardingData()
    {
        ...
        $result = SOFTSMAL_cURLOTP::callAPI($url, $param);
