 ...
 * @license  URI: http://www.gnu.org/licenses/gpl-2.0.html
 * @link     https://sms.softeriatech.com/
 * SOFTSMAL_PopupWidget class
 */
class SOFTSMAL_PopupWidget extends Widget_Base
{
        ...
        if (!empty($form_list)) { ?>
            <div <?php echo wp_kses_post($this->get_render_attribute_string('smspromodal_widget_wrapper')); ?>>
                   <?php    
                    ...
                    switch ($values) {
                    case "popup-1": 
                        echo SOFTSMAL_Popup::getModelStyle(array('sa_label'=>$sa_ele_f_mobile_lbl, 'placeholder' =>$sa_ele_f_mobile_placeholder, 'sa_button' =>$sa_ele_f_mobile_botton, 'sa_resend_otp' =>$sa_ele_f_otp_resend, 'sa_resend_btns' =>$sa_ele_f_resend_btn,'otp_template_style'=>'popup-1'));
                        break; 
                    case "popup-2":
                        echo SOFTSMAL_Popup::getModelStyle(array('sa_label'=>$sa_ele_f_mobile_lbl, 'placeholder' =>$sa_ele_f_mobile_placeholder, 'sa_button' =>$sa_ele_f_mobile_botton, 'sa_resend_otp' =>$sa_ele_f_otp_resend, 'sa_resend_btns' =>$sa_ele_f_resend_btn,'otp_template_style'=>'popup-2'));
                        break;
                    case "popup-3":
                        echo SOFTSMAL_Popup::getModelStyle(array('sa_label'=>$sa_ele_f_mobile_lbl, 'placeholder' =>$sa_ele_f_mobile_placeholder, 'sa_button' =>$sa_ele_f_mobile_botton, 'sa_resend_otp' =>$sa_ele_f_otp_resend, 'sa_resend_btns' =>$sa_ele_f_resend_btn,'otp_template_style'=>'popup-3'));
                        break;
                    case "popup-4":
                               echo SOFTSMAL_Popup::getModelStyle(array('sa_mobile_meaasege'=>$sa_edit_mobile_meaasege,'edit_phone_label'=>$sa_edit_mobile_number,'sa_label'=>$sa_ele_f_mobile_lbl, 'placeholder' =>$sa_ele_f_mobile_placeholder, 'sa_button' =>$sa_ele_f_mobile_botton, 'sa_resend_otp' =>$sa_ele_f_otp_resend, 'sa_resend_btns' =>$sa_ele_f_resend_btn,'otp_template_style'=>'popup-4'));
                        break;
