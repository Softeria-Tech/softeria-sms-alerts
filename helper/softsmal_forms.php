 ...
 * @license  URI: http://www.gnu.org/licenses/gpl-2.0.html
 * @link     https://sms.softeriatech.com/
 * SOFTSMAL_Forms class
 */
class SOFTSMAL_Forms extends Widget_Base
{
    ...
    {
        return __('Softeria Tech Forms', 'soft-sms-alerts');
    }
    ...
    protected function registerGeneralControls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __('Softeria Tech Forms', 'soft-sms-alerts'),
            ]
        );
        ...
        $this->add_control(
            'form_list',
            [
                'label'       => esc_html__('Softeria Tech Forms', 'soft-sms-alerts'),
        ...
        $this->add_control(
            ...
            [
            'type' => Controls_Manager::SELECT,
            'label' =>__('Select Group', 'soft-sms-alerts'),
        ...
        $this->add_control(
            ...
            [
                'label'        => __('Enable Title & Description', 'soft-sms-alerts'),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => __('Yes', 'soft-sms-alerts'),
                'label_off'    => __('No', 'soft-sms-alerts'),
                'return_value' => 'yes',
            'condition' => [
        ...
        $this->add_control(
            'form_title_custom',
            [
                'label'       => esc_html__('Title', 'soft-sms-alerts'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Description', 'soft-sms-alerts'),
        ...
        $this->add_control(
            'labels_switch',
            [
                'label'        => __('Enable Label', 'soft-sms-alerts'),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => 'yes',
                'label_on'     => __('Show', 'soft-sms-alerts'),
                'label_off'    => __('Hide', 'soft-sms-alerts'),
                'return_value' => 'yes',
            'condition' => [
                    'form_list' => ['sa_signup','sa_login','sa_subscription'],
                ],
        ...
        $this->add_control(
            'sa_ele_f_mobile_lbl',
            [
                'label'        => __('Label', 'soft-sms-alerts'),
                'type'         => "text",
        ...
        $this->add_control(
            ...
            [
                'label'        => __('Mobile Label', 'soft-sms-alerts'),
                'type'         => "text",
                'placeholder'      => 'Mobile',
            'condition' => [
                    'form_list' => ['sa_subscription'],
        ...
        $this->add_control(
            'placeholder_switch',
            [
                'label'        => __('Enable Placeholder', 'soft-sms-alerts'),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => 'yes',
                'label_on'     => __('Show', 'soft-sms-alerts'),
                'label_off'    => __('Hide', 'soft-sms-alerts'),
        ...
        $this->add_control(
            ...
            [
                'label'        => __("Mobile Placeholder", 'soft-sms-alerts'),
                'type'         => "text",
        ...
        $this->add_control(
            ...
            [
                'label'        => __('Redirect Url', 'soft-sms-alerts'),
                'type'         => "text",
    ...
    protected function registerFormContainerStyleControls()
    {
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Link Color', 'soft-sms-alerts'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => esc_html__('Max Width', 'soft-sms-alerts'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label'       => esc_html__('Alignment', 'soft-sms-alerts'),
                'type'        => Controls_Manager::CHOOSE,
                'label_block' => true,
                'options'     => [
                    'default' => [
                        'title' => __('Default', 'soft-sms-alerts'),
                        'icon'  => 'fa fa-ban',
                    ],
                    'left' => [
                        'title' => esc_html__('Left', 'soft-sms-alerts'),
                        'icon'  => 'eicon-h-align-left',
                    ],
                    'center' => [
                        'title' => esc_html__('Center', 'soft-sms-alerts'),
                        'icon'  => 'eicon-h-align-center',
                    ],
                    'right' => [
                        'title' => esc_html__('Right', 'soft-sms-alerts'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => esc_html__('Margin', 'soft-sms-alerts'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
    ...
    protected function registerLabelStyleControls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __('Labels', 'soft-sms-alerts'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    protected function registerInputTextareaStyleControls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __('Input & Textarea', 'soft-sms-alerts'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            'form_textarea_width',
            [
                'label' => __('Textarea Width', 'soft-sms-alerts'),
                'type'  => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min'  => 0,
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Textarea Height', 'soft-sms-alerts'),
                'type'  => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min'  => 0,
