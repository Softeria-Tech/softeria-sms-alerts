 ...
 * @license  URI: http://www.gnu.org/licenses/gpl-2.0.html
 * @link     https://sms.softeriatech.com/
 * SOFTSMAL_ExitIntentWidget class
 */
class SOFTSMAL_ExitIntentWidget extends Widget_Base
{
    ...
    {
        return 'softeria-alert-exitintent-widget';
    }
    ...
    {
        return [
            'softeria-alert-exitintent-styles',
    ...
    protected function render()
    {
        ...
        <?php
        echo SOFTSMAL_Popup::getExitIntentStyle(array('cvt_title' =>$sa_ele_f_mobile_title, 'cvt_description' =>$sa_ele_f_mobile_description, 'cvt_label' =>$sa_ele_f_mobile_label, 'cvt_placeholder' =>$sa_ele_f_mobile_placeholder, 'cvt_button' =>$sa_submit_button));
