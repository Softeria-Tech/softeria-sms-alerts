 ...
 * @license  URI: http://www.gnu.org/licenses/gpl-2.0.html
 * @link     https://sms.softeriatech.com/
 * SOFTSMAL_NotifyMeWidget class
 */
class SOFTSMAL_NotifyMeWidget extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        ?>
            <div <?php echo wp_kses_post($this->get_render_attribute_string('smspronotifyme_widget_wrapper')); ?>>
                   <?php
                    echo SOFTSMAL_Popup::getNotifyMeStyle(array('notify_title'=>$sa_ele_f_notifyme_title,'notify_placeholder'=>$sa_ele_f_notifyme_placehoder,'notify_button'=>$sa_notifyme_button));                     
    }    
