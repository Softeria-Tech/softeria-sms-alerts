 ...
 * @license  URI: http://www.gnu.org/licenses/gpl-2.0.html
 * @link     https://sms.softeriatech.com/
 * SOFTSMAL_Abandoned_Cart class
 */
class SOFTSMAL_Abandoned_Cart
{
    ...
    {
        $this->loader = new SOFTSMAL_Loader();
    }
    ...
    {
        $plugin_admin = new SOFTSMAL_Cart_Admin($this->getPluginName(), $this->getVersion());
    ...
    {
        $plugin_admin  = new SOFTSMAL_Cart_Admin($this->getPluginName(), $this->getVersion());
        $plugin_public = new SOFTSMAL_Cart_Public($this->getPluginName(), $this->getVersion());
    ...
    public function addTabs( $tabs = array() )
    {
        ...
        $tabs['woocommerce']['inner_nav']['abandoned_cart']['params'] = $smsprocart_param;
        return $tabs;
    }
    ...
    public function getSmsAlertCartTemplates()
    {
        ...
        if (empty($scheduler_data) ) {
            ...
            'frequency' => '60',
            'message'   => SOFTSMAL_Messages::showMessage('DEFAULT_AB_CART_CUSTOMER_MESSAGE'),
            );
            $scheduler_data['cron'][] = array(
            'frequency' => '120',
            'message'   => SOFTSMAL_Messages::showMessage('DEFAULT_AB_CART_CUSTOMER_MESSAGE'),
 ...
 * @license  URI: http://www.gnu.org/licenses/gpl-2.0.html
 * @link     https://sms.softeriatech.com/
 * SOFTSMAL_Loader class.
 */
class SOFTSMAL_Loader
{
 ...
 * @license  URI: http://www.gnu.org/licenses/gpl-2.0.html
 * @link     https://sms.softeriatech.com/
 * SOFTSMAL_Cart_Admin class.
 */
class SOFTSMAL_Cart_Admin
{
    ...
    {
        if (! class_exists('SOFTSMAL_Admin_Table') ) {
            return;
        }
        global $wpdb, $pagenow;
        $table_name = $wpdb->prefix . CHECKOUT_VIEW_NAME;

        $wp_list_table = new SOFTSMAL_Admin_Table();
    ...
    public static function display_reports_page()
    {
        if ('ab-cart-reports' === $_GET['page'] ) {
            wp_enqueue_script(
                ...
                '',
                SOFTSMAL_Constants::SA_VERSION,
                false
            );
            wp_register_script('reports_js', SA_MOV_URL . 'js/ab-cart-graph.js', '', SOFTSMAL_Constants::SA_VERSION, false);
    ...
    public function parseSmsBody( $data = array(), $content = null )
    {
        ...
        $order_variables = SOFTSMAL_Abandoned_Cart::getAbandonCartvariables();
    ...
    function clearCartData( $order_id = null )
    {
        ...
        if (isset(WC()->session) ) {
            ...
            if (isset($cart_session_id) ) {
                $public        = new SOFTSMAL_Cart_Public(SOFTERIA_ALERTS_PLUGIN_NAME_SLUG, SOFTSMAL_Constants::SA_VERSION);
 ...
 * @license  URI: http://www.gnu.org/licenses/gpl-2.0.html
 * @link     https://sms.softeriatech.com/
 * SOFTSMAL_Admin_Table class
 */
class SOFTSMAL_Admin_Table extends WP_List_Table
{
 ...
 * @license  URI: http://www.gnu.org/licenses/gpl-2.0.html
 * @link     https://sms.softeriatech.com/
 * SOFTSMAL_Cart_Public class
 */
class SOFTSMAL_Cart_Public
{
    ...
    public function enqueueStyles()
    {
        if ($this->exitIntentEnabled() ) { // If Exit Intent Enabled
            wp_enqueue_style($this->plugin_name, SA_MOV_URL . 'css/ab-public.css', array(), SOFTSMAL_Constants::SA_VERSION, 'all');
        }
    }
    ...
    public function enqueueScripts()
    {
        if ($this->exitIntentEnabled() ) { // If Exit Intent Enabled
            ...
            if (is_user_logged_in() ) {
                ...
                $plugin_admin   = new SOFTSMAL_Cart_Admin(SOFTERIA_ALERTS_PLUGIN_NAME_SLUG, SOFTSMAL_Constants::SA_VERSION);
            }
            ...
            if (softeria_alerts_get_option('cart_exit_intent_status', 'softeria_alerts_abandoned_cart', '0') ) {
                ...
                wp_enqueue_script($this->plugin_name . 'exit_intent', SA_MOV_URL . 'js/ab-public-exit-intent.js', array( 'jquery' ), SOFTSMAL_Constants::SA_VERSION, false);
    ...
    public function addAdditionalScriptsOnCheckout()
    {
        ...
        wp_enqueue_script($this->plugin_name, SA_MOV_URL . 'js/ab-cart-public.js', array( 'jquery' ), SOFTSMAL_Constants::SA_VERSION, false);
    ...
    function saveUserData()
    {
        ...
        if (isset($_POST['ab_cart_phone']) ) {
            ...
            $phone = SOFTSMAL_Utility::formatNumberForCountryCode($phone);
            $other_fields = array(
