...
if (! is_plugin_active('woocommerce/woocommerce.php') ) {
     ...
     * @license  URI: http://www.gnu.org/licenses/gpl-2.0.html
     * @link     https://sms.softeriatech.com/
     * SOFTSMAL_LowStock class
     */
class SOFTSMAL_LowStock
{
    /**
     * Construct function
     *
    ...
    public static function getWcStockTemplates()
    {
        ...
        $sms_body_admin_low_stock_msg = softeria_alerts_get_option('sms_body_admin_low_stock_msg', 'softeria_alerts_message', SOFTSMAL_Messages::showMessage('DEFAULT_ADMIN_LOW_STOCK_MSG'));

        $softeria_alerts_out_of_stock_admin_msg = softeria_alerts_get_option('admin_out_of_stock_msg', 'softeria_alerts_general', 'on');
        $sms_body_admin_out_of_stock_msg = softeria_alerts_get_option('sms_body_admin_out_of_stock_msg', 'softeria_alerts_message', SOFTSMAL_Messages::showMessage('DEFAULT_ADMIN_OUT_OF_STOCK_MSG'));
