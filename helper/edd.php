...
class SmsAlertEdd
{
    ...
    public function __construct()
    {
        ...
        add_action('edd_purchase_form_user_info', __CLASS__ . '::smsproEddDisplayCheckoutFields');
        add_action('edd_checkout_error_checks', __CLASS__ . '::smsproEddValidateCheckoutFields', 10, 2);
        add_filter('edd_purchase_form_required_fields', __CLASS__ . '::smsproEddRequiredCheckoutFields');
        add_filter('edd_payment_meta', __CLASS__ . '::smsproEddStoreCustomFields');
        add_action('edd_payment_personal_details_list', __CLASS__ . '::smsproEddViewOrderDetails', 10, 2);
        add_action('edd_add_email_tags', __CLASS__ . '::smsproEddAddPhoneTag');
     ...
     * @return void
     */
    public static function smsproSettings( $templates )
    {
     ...
     * @return void
     */
    public static function smsproEddDisplayCheckoutFields()
    {
     ...
     * @return array
     */
    public static function smsproEddRequiredCheckoutFields( $required_fields )
    {
     ...
     * @return void
     */
    public static function smsproEddValidateCheckoutFields( $valid_data, $data )
    {
     ...
     * @return array
     */
    public static function smsproEddStoreCustomFields( $payment_meta )
    {
     ...
     * @return void
     */
    public static function smsproEddViewOrderDetails( $payment_meta, $user_info )
    {
     ...
     * @return void
     */
    public static function smsproEddAddPhoneTag()
    {
        edd_add_email_tag('phone', 'Customer\'s phone number', 'smsproEddTagPhone');
    }
     ...
     * @return string
     */
    public static function smsproEddTagPhone( $payment_id )
    {
