...
class SmsAlertLearnPress
{
    ...
    public function __construct()
    {
        ...
        add_action('learn-press/user-enrolled-course/notification', __CLASS__ . '::smsproLpSendSmsUserEnroll', 10, 3);

        add_action('learn-press/order/status-changed', __CLASS__ . '::smsproLpSendSmsOnChangedStatus', 10, 3);

        add_action('set_user_role', __CLASS__ . '::smsproLpAfterBecomeTeacher', 10, 3);
        add_action('learn-press/user-course-finished/notification', __CLASS__ . '::smsproLpUserCourseFinished', 10, 3);

        add_action('learn-press/payment-form', __CLASS__ . '::smsproShowButtonAtCheckout', 15);

        add_action('learn-press/checkout-order-processed', __CLASS__ . '::smsproLpSavedBillingPhone', 10, 2);
     ...
     * @return void
     */
    public static function smsproShowButtonAtCheckout()
    {
     ...
     * @return void
     */
    public static function smsproLpSavedBillingPhone( $order_id, $data )
    {
